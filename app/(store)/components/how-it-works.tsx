const STEPS = [
  ...
  { n: "3", title: "Open the package", body: "We pack it with care and send it your way. That's the whole story.", color: "var(--so-reef)" },
] as const;
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
      ...
      <h2 className="so-display mt-4 max-w-xl text-4xl text-[color:var(--so-cream)] sm:text-5xl">
        Three steps. Then the <em className="font-normal" style={{ color: "var(--so-lagoon)" }}>package</em>.
      </h2>
