...
import { submitCustomerCustomizationRequest } from "@/lib/domains/intelligence/customer-create";
  ...
  try {
    ...
    if (!result.mockupPreviewUrl) {
      return {
        ok: false,
        error:
          "Sweet'Oh AI couldn't generate a preview right now — try again in a bit.",
      };
    }
